...
var snowsrc = 'assets/images/justin/ribbon.gif';
// Configure below to change number of snow to render
var no = 10;
// Configure whether snow should disappear after x seconds (0=never):
var hidesnowtime = 0;
// Configure how much snow should drop down before fading ("windowheight" or "pageheight")
var snowdistance = 'windowheight'; /* modified to window height (or else snow will keep falling and extend page) */
...
stx = new Array();
sty = new Array();
snowsrc = snowsrc.indexOf('dynamicdrive.com') != -1 ? 'ribbon.gif' : snowsrc;
for (i = 0; i < no; ++i) {
